...
and reload capabilities from a dictionary source.
"""


class Student:
    """
    Represents a student with personal details and disk sync methods.
    """
    ...
    def reload_from_json(self, json):
        ...
        Args:
            json (dict): A dictionary where keys match the instance attributes.
        """
