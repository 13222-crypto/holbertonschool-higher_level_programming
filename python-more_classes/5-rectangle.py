...
validation properties, geometric methods, and deletion detection.
"""


class Rectangle:
    """
    Defines a rectangle by width and height with life-cycle tracking.
    ...
    def __del__(self):
        """
        Prints a specific message upon deletion of a Rectangle instance.
        """
        print("Bye rectangle...")
